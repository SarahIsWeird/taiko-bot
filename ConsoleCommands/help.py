def run(consoleInput, conf, api, ircName):
	...
	print('<3     mods |  m: Sets enabled mods for the last queried map!')
	print('<3  mapinfo | mi: Prints the beatmap array for the last queried map!')
	print('<3     help |   : Shows this list of commands!')
